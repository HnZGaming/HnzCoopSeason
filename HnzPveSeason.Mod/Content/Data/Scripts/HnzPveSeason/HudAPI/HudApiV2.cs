...
namespace HnzPveSeason.HudAPI
{
	public class HudAPIv2
	{
		...
		public abstract class MessageBase
		{
			...
			/// </summary>
			public MyBillboard.BlendTypeEnum Blend
			{
				get
				{
					return (MyBillboard.BlendTypeEnum)(instance.MessageGet(BackingObject, (int)MessageBaseMembers.BlendType));
				}
				set
				{
		...
		public class EntityMessage : MessageBase
		{
			...
			public EntityMessage(StringBuilder Message, IMyEntity Entity, Vector3D LocalPosition, Vector3D Forward, Vector3D Up, int TimeToLive = -1, double Scale = 1, TextOrientation Orientation = TextOrientation.ltr, Vector2D? Offset = null, Vector2D? Max = null, MyBillboard.BlendTypeEnum Blend = MyBillboard.BlendTypeEnum.Standard)
			{
				instance.RegisterCheck();
				BackingObject = instance.CreateMessage(MessageTypes.EntityMessage);
				if(BackingObject != null)
		...
		public class HUDMessage : MessageBase
		{
			...
			public HUDMessage(StringBuilder Message, Vector2D Origin, Vector2D? Offset = null, int TimeToLive = -1,   double Scale = 1.0d, bool HideHud = true, bool Shadowing = false, Color? ShadowColor = null, MyBillboard.BlendTypeEnum Blend = MyBillboard.BlendTypeEnum.SDR)
			{
				instance.RegisterCheck();
		...
		public class BillBoardHUDMessage : MessageBase
		{
			...
			public BillBoardHUDMessage(MyStringId Material, Vector2D Origin, Color BillBoardColor, Vector2D? Offset = null, int TimeToLive = -1, double Scale = 1d, float Width = 1f, float Height = 1f, float Rotation = 0, bool HideHud = true, bool Shadowing = true, MyBillboard.BlendTypeEnum Blend = MyBillboard.BlendTypeEnum.SDR)
			{
				instance.RegisterCheck();
		...
		public class SpaceMessage : MessageBase
		{
			...
			public SpaceMessage(StringBuilder Message, Vector3D WorldPosition, Vector3D Up, Vector3D Left, double Scale = 1, Vector2D? Offset = null, int TimeToLive = -1,  TextOrientation TxtOrientation = TextOrientation.ltr, MyBillboard.BlendTypeEnum Blend = MyBillboard.BlendTypeEnum.Standard)
			{
				instance.RegisterCheck();
