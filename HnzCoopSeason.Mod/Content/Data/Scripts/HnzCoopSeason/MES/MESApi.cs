...
namespace HnzCoopSeason.MES {
	public class MESApi {
		...
		{
			Instance = new MESApi();
			MyAPIGateway.Utilities.RegisterMessageHandler(_mesModId, Instance.APIListener);
		}

		public static void Unload()
		{
			if (Instance == null) return;
			MyAPIGateway.Utilities.UnregisterMessageHandler(_mesModId, Instance.APIListener);
		}
		...
		*/
		...
		void APIListener(object data) {
			...
			{
				throw new InvalidOperationException($"MES failed to load; error: {e}");
			}
